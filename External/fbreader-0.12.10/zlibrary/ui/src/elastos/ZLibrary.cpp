...
#include "../../../core/src/elastos/filesystem/ZLElFSManager.h"
#include "../../../core/src/elastos/xmlconfig/XMLConfig.h"
#include "../../../core/src/options/ZLConfig.h"
#include "../../../core/src/network/ZLNetworkManager.h"
...
#define BASEDIR "/data/data/com.elastos.runtime/elastos/FBReader/res/fbdata"
#define IMAGEDIR "share/pixmaps"
#define APPIMAGEDIR "share/pixmaps/fbreader"
...
//    ZLWin32ConfigManager::createInstance();
    ZLElFSManager::createInstance();
    XMLConfigManager::createInstance();
    ZLOption::createInstance();
//    ZLElTime::createInstance();
...
void ZLibrary::shutdown() {
    ...
    XMLConfigManager::deleteInstance();
