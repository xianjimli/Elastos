    ...
    /* [in] */ ICanvas* canvas) 
{
    ...
    for (Int32 i = 0, childFlPos = mFirstPosition - headerViewsCount; i < childCount;
        ...
        if (((CExpandableListPosition*)((CPositionMetadata*)pos.Get())->position.Get())->type != lastItemType) {
            if (((CExpandableListPosition*)((CPositionMetadata*)pos.Get())->position.Get())->type == ExpandableListPosition::CHILD) {
            ...
            lastItemType = ((CExpandableListPosition*)((CPositionMetadata*)pos.Get())->position.Get())->type; 
        }
    ...
    /* [in] */ IPositionMetadata* pos) 
{
    ...
    if (((CExpandableListPosition*)(((CPositionMetadata*)pos)->position.Get()))->type == ExpandableListPosition::GROUP) {
        ...
        if (indicator.Get() != NULL && stateful) {
            ...
            Boolean isEmpty = (((CPositionMetadata*)pos)->groupMetadata == NULL) ||
                    (((CGroupMetadata*)((CPositionMetadata*)pos)->groupMetadata.Get())->lastChildFlPos == ((CGroupMetadata*)((CPositionMetadata*)pos)->groupMetadata.Get())->flPos);
        ...
        if (indicator != NULL && stateful) {
            ...
            Int32* stateSet = ((CExpandableListPosition*)((CPositionMetadata*)pos)->position.Get())->flatListPos == ((CGroupMetadata*)(((CPositionMetadata*)pos)->groupMetadata.Get()))->lastChildFlPos
    ...
    /* [in] */ Int32 childIndex)
{
    ...
    if (flatListPosition >= 0) {
        ...
        Boolean expanded;
        pos->IsExpanded(&expanded);
        if ((((CExpandableListPosition*)((CPositionMetadata*)pos.Get())->position.Get())->type == ExpandableListPosition::CHILD) || (expanded &&
                ((CGroupMetadata*)((CPositionMetadata*)pos.Get())->groupMetadata.Get())->lastChildFlPos != ((CGroupMetadata*)((CPositionMetadata*)pos.Get())->groupMetadata.Get())->flPos)) {
    ...
    /* [in] */ Int64 id)
{
    ...
    id = GetChildOrGroupId(((CPositionMetadata*)posMetadata.Get())->position);
    ...
    if (((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->type == ExpandableListPosition::GROUP) {
        ...
        if (mOnGroupClickListener.Get() != NULL) {
            ...
            mOnGroupClickListener->OnGroupClick((IExpandableListView*)this->Probe(EIID_IExpandableListView), v,
                ((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->groupPos, id, &res);
            if (res) {
                posMetadata->Recycle();
                return TRUE;
            }
        ...
        if (expanded) {
            ...
            if (mOnGroupCollapseListener.Get() != NULL) {
                mOnGroupCollapseListener->OnGroupCollapse(((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->groupPos);
            }
        } else {
            /* Expand it */
            ...
            if (mOnGroupExpandListener.Get() != NULL) {
                mOnGroupExpandListener->OnGroupExpand(((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->groupPos);
            }
            
            Int32 groupPos = ((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->groupPos;
            Int32 groupFlatPos = ((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->flatListPos;
        ...
        if (mOnChildClickListener.Get() != NULL) {
            ...
            mOnChildClickListener->OnChildClick((IExpandableListView*)(this->Probe(EIID_IExpandableListView)), v, 
                ((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->groupPos,
                    ((CExpandableListPosition*)((CPositionMetadata*)posMetadata.Get())->position.Get())->childPos, id, &returnValue);
            return returnValue;
        }
    ...
    /* [in] */ Int32 flatListPosition)
{
    ...
    Int64 packedPos;
    ((CExpandableListPosition*)((CPositionMetadata*)pm.Get())->position.Get())->GetPackedPosition(&packedPos);
    pm->Recycle();
    return packedPos;
}
    ...
    /* [in] */ Int64 packedPosition)
{
    ...
    Int32 flatListPosition = ((CExpandableListPosition*)((CPositionMetadata*)pm.Get())->position.Get())->flatListPos;
    pm->Recycle();
    ...
    /* [in] */ Int32 groupPosition)
{
    ...
    elGroupPos->Recycle();
    Int32 absoluteFlatPosition = GetAbsoluteFlatPosition(((CExpandableListPosition*)((CPositionMetadata*)pm.Get())->position.Get())->flatListPos);
    ...
    /* [in] */ Boolean shouldExpandGroup)
{
    ...
    Int32 absoluteFlatPosition = GetAbsoluteFlatPosition(((CExpandableListPosition*)((CPositionMetadata*)flatChildPos.Get())->position.Get())->flatListPos);
    ListView::SetSelection(absoluteFlatPosition);
    ...
    /* [in] */ Int64 id) 
{
    ...
    AutoPtr<IPositionMetadata> pm;
    mConnector->GetUnflattenedPos(adjustedPosition, (IPositionMetadata**)&pm);
    AutoPtr<IExpandableListPosition> pos = ((CPositionMetadata*)pm.Get())->position;
    pm->Recycle();
