    ...
    /* [in] */ Int32 index)
{
    ...
    memcpy(mKeys->GetPayload() + index, mKeys->GetPayload() + index + 1, (mSize - index - 1) * sizeof(Int32));

    //System.arraycopy(mValues, index + 1, mValues, index, mSize - (index + 1));
    memcpy(mValues->GetPayload() + index, mValues->GetPayload() + index + 1, (mSize - index - 1) * sizeof(Int32));
