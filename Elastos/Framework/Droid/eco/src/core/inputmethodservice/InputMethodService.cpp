...
ECode InputMethodService::GetAssets(
    /* [out] */ IAssetManager** assetManager)
{
    VALIDATE_NOT_NULL(assetManager);
    return AbstractInputMethodService::GetAssets(assetManager);
}

ECode InputMethodService::GetResources(
    /* [out] */ IResources** resources)
{
    VALIDATE_NOT_NULL(resources);
    return AbstractInputMethodService::GetResources(resources);
}

ECode InputMethodService::GetCapsuleManager(
    /* [out] */ ILocalCapsuleManager** capsuleManager)
{
    VALIDATE_NOT_NULL(capsuleManager);
    return AbstractInputMethodService::GetCapsuleManager(capsuleManager);
}

ECode InputMethodService::GetContentResolver(
    /* [out] */ IContentResolver** resolver)
{
    VALIDATE_NOT_NULL(resolver);
    return AbstractInputMethodService::GetContentResolver(resolver);
}

ECode InputMethodService::GetApplicationContext(
    /* [out] */ IContext** ctx)
{
    VALIDATE_NOT_NULL(ctx);
    return AbstractInputMethodService::GetApplicationContext(ctx);
}

ECode InputMethodService::GetText(
    /* [in] */ Int32 resId,
    /* [out] */ ICharSequence** text)
{
    VALIDATE_NOT_NULL(text);
    return AbstractInputMethodService::GetText(resId, text);
}

ECode InputMethodService::GetString(
    /* [in] */ Int32 resId,
    /* [out] */ String* str)
{
    VALIDATE_NOT_NULL(str);
    return AbstractInputMethodService::GetString(resId, str);
}

ECode InputMethodService::GetTheme(
    /* [out] */ ITheme** theme)
{
    VALIDATE_NOT_NULL(theme);
    return AbstractInputMethodService::GetTheme(theme);
}

ECode InputMethodService::ObtainStyledAttributes(
    /* [in] */ const ArrayOf<Int32>& attrs,
    /* [out] */ ITypedArray** styles)
{
    VALIDATE_NOT_NULL(styles);
    return AbstractInputMethodService::ObtainStyledAttributes(attrs, styles);
}

ECode InputMethodService::ObtainStyledAttributesEx(
    /* [in] */ Int32 resid,
    /* [in] */ const ArrayOf<Int32>& attrs,
    /* [out] */ ITypedArray** styles)
{
    VALIDATE_NOT_NULL(styles);
    return AbstractInputMethodService::ObtainStyledAttributesEx(resid, attrs, styles);
}

ECode InputMethodService::ObtainStyledAttributesEx2(
    /* [in] */ IAttributeSet* set,
    /* [in] */ const ArrayOf<Int32>& attrs,
    /* [out] */ ITypedArray** styles)
{
    VALIDATE_NOT_NULL(styles);
    return AbstractInputMethodService::ObtainStyledAttributesEx2(set, attrs, styles);
}

ECode InputMethodService::ObtainStyledAttributesEx3(
    /* [in] */ IAttributeSet* set,
    /* [in] */ const ArrayOf<Int32>& attrs,
...
{
    VALIDATE_NOT_NULL(styles);
    return AbstractInputMethodService::ObtainStyledAttributesEx3(set, attrs, defStyleAttr, defStyleRes, styles);
}

ECode InputMethodService::GetClassLoader(
    /* [out] */ IClassLoader** loader)
{
    VALIDATE_NOT_NULL(loader);
    return AbstractInputMethodService::GetClassLoader(loader);
}

ECode InputMethodService::GetCapsuleName(
    /* [out] */ String* capsuleName)
{
    VALIDATE_NOT_NULL(capsuleName);
    return AbstractInputMethodService::GetClassName(capsuleName);
}

ECode InputMethodService::GetApplicationInfo(
    /* [out] */ IApplicationInfo** info)
{
    VALIDATE_NOT_NULL(info);
    return AbstractInputMethodService::GetApplicationInfo(info);
}

ECode InputMethodService::StartActivity(
    /* [in] */ IIntent* intent)
{
    return AbstractInputMethodService::StartActivity(intent);
}

ECode InputMethodService::SendBroadcast(
    /* [in] */ IIntent* intent)
{
    return AbstractInputMethodService::SendBroadcast(intent);
}

ECode InputMethodService::StartService(
    /* [in] */ IIntent* service,
    /* [out] */ IComponentName** name)
{
    VALIDATE_NOT_NULL(name);
    return AbstractInputMethodService::StartService(service, name);
}

ECode InputMethodService::StopService(
    /* [in] */ IIntent* service,
    /* [out] */ Boolean* succeeded)
{
    VALIDATE_NOT_NULL(succeeded);
    return AbstractInputMethodService::StopService(service, succeeded);
}

ECode InputMethodService::BindService(
    /* [in] */ IIntent* service,
...
{
    VALIDATE_NOT_NULL(succeeded);
    return AbstractInputMethodService::BindService(service, conn, flags, succeeded);
}

ECode InputMethodService::UnbindService(
    /* [in] */ IServiceConnection* conn)
{
    return AbstractInputMethodService::UnbindService(conn);
}

ECode InputMethodService::GetSystemService(
    /* [in] */ CString name,
    /* [out] */ IInterface** object)
{
    VALIDATE_NOT_NULL(object);
    return AbstractInputMethodService::GetSystemService(name, object);
}

ECode InputMethodService::CreateCapsuleContext(
    /* [in] */ const String& capsuleName,
    /* [in] */ Int32 flags,
    /* [out] */ IContext** ctx)
{
    VALIDATE_NOT_NULL(ctx);
    return AbstractInputMethodService::CreateCapsuleContext(capsuleName, flags, ctx);
}

ECode InputMethodService::CheckCallingPermission(
    /* [in] */ const String& permission,
    /* [out] */ Int32* value)
{
    VALIDATE_NOT_NULL(value);
    return AbstractInputMethodService::CheckCallingPermission(permission, value);
}

ECode InputMethodService::EnforceCallingOrSelfPermission(
    /* [in] */ CString permission,
    /* [in] */ CString message)
{
    return AbstractInputMethodService::EnforceCallingOrSelfPermission(permission, message);
}

ECode InputMethodService::RevokeUriPermission(
    /* [in] */ IUri* uri,
    /* [in] */ Int32 modeFlags)
{
    return AbstractInputMethodService::RevokeUriPermission(uri, modeFlags);
}

ECode InputMethodService::CheckCallingOrSelfPermission(
    /* [in] */ const String& permission,
    /* [out] */ Int32* perm)
{
    VALIDATE_NOT_NULL(perm);
    return AbstractInputMethodService::CheckCallingOrSelfPermission(permission, perm);
}

ECode InputMethodService::GrantUriPermission(
    /* [in] */ const String& toCapsule,
    /* [in] */ IUri* uri,
    /* [in] */ Int32 modeFlags)
{
    return AbstractInputMethodService::GrantUriPermission(toCapsule, uri, modeFlags);
}
