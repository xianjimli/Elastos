    ...
    /* [in] */ IRunnable* restarter)
{
    ...
    mCapsuleName = String::Duplicate(((CServiceInfo*)sInfo)->mApplicationInfo->mCapsuleName);
    mProcessName = String::Duplicate(((CServiceInfo*)sInfo)->mProcessName);
    mPermission = String::Duplicate(((CServiceInfo*)sInfo)->mPermission);
    mBaseDir = String::Duplicate(((CServiceInfo*)sInfo)->mApplicationInfo->mSourceDir);
    mResDir = String::Duplicate(((CServiceInfo*)sInfo)->mApplicationInfo->mPublicSourceDir);
    mDataDir = String::Duplicate(((CServiceInfo*)sInfo)->mApplicationInfo->mDataDir);
