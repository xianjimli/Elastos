...
#ifndef __SOUNDPOOL_H__
#define __SOUNDPOOL_H__
...
public:
     ...
     */
    virtual CARAPI_(Boolean) Unload(
        /* [in] */ Int32 soundID);
     ...
     */
    virtual CARAPI SetOnLoadCompleteListener(
