...
public:
    ...
    private static const String Y_M_D_T_H_M_S_000 = "%Y-%m-%dT%H:%M:%S.000";
    private static const String Y_M_D_T_H_M_S_000_Z = "%Y-%m-%dT%H:%M:%S.000Z";
    private static const String Y_M_D = "%Y-%m-%d";
    
    public static const String TIMEZONE_UTC = "UTC";

    /**
     * The Julian day of the epoch, that is, January 1, 1970 on the Gregorian
     * calendar.
     */
    public static const Int32 EPOCH_JULIAN_DAY = 2440588;
     ...
     * getActualMaximum().
     */
    public static const Int32 SECOND = 1;
    public static const Int32 MINUTE = 2;
    public static const Int32 HOUR = 3;
    public static const Int32 MONTH_DAY = 4;
    public static const Int32 MONTH = 5;
    public static const Int32 YEAR = 6;
    public static const Int32 WEEK_DAY = 7;
    public static const Int32 YEAR_DAY = 8;
    public static const Int32 WEEK_NUM = 9;

    public static const Int32 SUNDAY = 0;
    public static const Int32 MONDAY = 1;
    public static const Int32 TUESDAY = 2;
    public static const Int32 WEDNESDAY = 3;
    public static const Int32 THURSDAY = 4;
    public static const Int32 FRIDAY = 5;
    public static const Int32 SATURDAY = 6;
