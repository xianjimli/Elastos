...
template<> struct EqualTo<AutoPtr<ILocalGpsStatusListener> >
{
    Boolean operator()(const AutoPtr<ILocalGpsStatusListener>& x,
                       const AutoPtr<ILocalGpsStatusListener>& y) const
    {
        return x.Get() == y.Get();
    }
};
...
template<> struct EqualTo<AutoPtr<ILocalGpsStatusNmeaListener> >
{
    Boolean operator()(const AutoPtr<ILocalGpsStatusNmeaListener>& x,
                       const AutoPtr<ILocalGpsStatusNmeaListener>& y) const
    {
        return x.Get() == y.Get();
    }
};
...
template<> struct EqualTo<AutoPtr<ILocalLocationListener> >
{
    Boolean operator()(const AutoPtr<ILocalLocationListener>& x,
                       const AutoPtr<ILocalLocationListener>& y) const
    {
        return x.Get() == y.Get();
    }
};
...
private:
    ...
    HashMap<AutoPtr<ILocalGpsStatusListener>,
            AutoPtr<CGpsStatusListenerTransport> > mGpsStatusListeners;
    HashMap<AutoPtr<ILocalGpsStatusNmeaListener>,
            AutoPtr<CGpsStatusListenerTransport> > mNmeaListeners;
    AutoPtr<IGpsStatus> mGpsStatus;
    Mutex mGpsStatusLock;

    // Map from LocationListeners to their associated ListenerTransport objects
    HashMap<AutoPtr<ILocalLocationListener>, AutoPtr<CListenerTransport> > mListeners;
