...
private:
    ...
    class MyWindow : /*public IBaseIWindow,*/ public ElRefBase
    {
    public:
        MyWindow(
            /* [in] */ ISurfaceView* surfaceView);

        virtual CARAPI_(void) Resized(
            /* [in] */ Int32 w, 
            /* [in] */ Int32 h, 
        ...
        virtual CARAPI_(void) DispatchAppVisibility(
            /* [in] */ Boolean visible);

        virtual CARAPI_(void) DispatchGetNewSurface();

        virtual CARAPI_(void) WindowFocusChanged(
            /* [in] */ Boolean hasFocus, 
            /* [in] */ Boolean touchEnabled);

        virtual CARAPI_(void) ExecuteCommand(
            /* [in] */ String command, 
    ...
    AutoPtr<CRect> mVisibleInsets;// = new Rect();
    AutoPtr<CRect> mWinFrame;// = new Rect();
    AutoPtr<CRect> mContentInsets;// = new Rect();
