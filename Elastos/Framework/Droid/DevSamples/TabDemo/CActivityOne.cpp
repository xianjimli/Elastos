    ...
    /* [in] */ IBundle* savedInstanceState)
{
    ...
    AutoPtr<ITabHost> tabHost = ITabHost::Probe(view);
    tabHost->Setup();
    AutoPtr<ITabWidget> tabWidget;
    tabHost->GetTabWidget((ITabWidget**)&tabWidget);
    assert(tabWidget != NULL);

    AutoPtr<ICharSequence> cs;
    AutoPtr<ITabSpec> tabSpec;

    CStringWrapper::New(String("tab1"), (ICharSequence**)&cs);
    tabHost->NewTabSpec(String("tab1"), (ITabSpec**)&tabSpec);
    tabSpec->SetIndicator(cs);
    tabSpec->SetContent(0x7f050002);
    tabHost->AddTab(tabSpec);

    tabSpec = NULL;
    cs = NULL;
    CStringWrapper::New(String("tab2"), (ICharSequence**)&cs);
    tabHost->NewTabSpec(String("tab2"), (ITabSpec**)&tabSpec);
    tabSpec->SetIndicator(cs);
    tabSpec->SetContent(0x7f050003);
    tabHost->AddTab(tabSpec);

    tabSpec = NULL;
    cs = NULL;
    CStringWrapper::New(String("tab3"), (ICharSequence**)&cs);
    tabHost->NewTabSpec(String("tab3"), (ITabSpec**)&tabSpec);
    tabSpec->SetIndicator(cs);
    tabSpec->SetContent(0x7f050004);
    tabHost->AddTab(tabSpec);
