    ...
    /*[in]*/ const BufferOf<Byte>& cbuf)
{
    ...
    //assert(cbuf != NULL);
    Int32 number;
    Character::GetCharCount(cbuf, offset, cbuf.GetCapacity(), &number);
...
//      throw new IndexOutOfBoundsException();
    ...
    // END android-changed
    Int32 index;
    Character::GetOffsetByChars(cbuf, 0, cbuf.GetCapacity(), offset, count, &index);
