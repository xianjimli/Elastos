    ...
    /* [out] */ Int32* number)
{
    ...
    Int32 length = (*localBuf)->GetCapacity();
    ...
    mCount = mMarkpos = 0;
    Int32 bytesread;
    FAIL_RETURN(localIn->ReadBufferEx(mPos, (*localBuf)->GetCapacity() - mPos,
            *localBuf, &bytesread));
...
//      throw new NullPointerException("buffer == null");
    ...
    if ((offset | length) < 0 || offset > buffer->GetCapacity() - length) {
//      throw new IndexOutOfBoundsException();
    ...
    while (TRUE) {
         ...
         */
        if (mMarkpos == -1 && required >= localBuf->GetCapacity()) {
