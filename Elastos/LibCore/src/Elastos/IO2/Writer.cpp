...
const String Writer::TOKEN_NULL = "NULL";
    ...
    /* [in] */ const BufferOf<Byte>& buffer)
{
    ...
    // END android-note
    Int32 count;
    FAIL_RETURN(Character::GetCharCount(buffer, 0, buffer.GetCapacity(), &count));
...
//      throw new StringIndexOutOfBoundsException();
    ...
    BufferOf<Byte> buf((Byte*)(const char*)str, str.GetLength());
    assert(mLock != NULL);
    Mutex::Autolock lock(mLock);
