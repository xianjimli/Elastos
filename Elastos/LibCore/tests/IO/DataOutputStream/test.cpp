  ...
  int CTest::TestWriteByte(int argc,char *argv[])
{
 ...
 /*
 *FAIL_RETURN(mOut->WriteBuffer(buffer));后不知道进哪里了
 * 运行方式: clDataOutputStream.ecx 10
 *
 */
 ...
 * 预期结果: OK
 *
 * 运行方式: clDataOutputStream.ecx 11
 */
