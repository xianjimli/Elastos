...
class Connection : public Wrapper{
public:
	/**
     ...
     *             if there is a problem accessing the database
     */
    virtual CARAPI CreateStatementEx(
     ...
     *             if there is a problem accessing the database.
     */
    virtual CARAPI CreateStatementEx2(
        /** [in] **/Int32 resultSetType,
        /** [in] **/Int32 resultSetConcurrency, 
     ...
     *             if there is a problem accessing the database.
     */
//    virtual CARAPI  Map<String, Class<?>> GetTypeMap()=0;
     ...
     *             closed.
     */
//S    virtual CARAPI  SQLWarning GetWarnings()=0;
     ...
     *             if there is a problem accessing the database.
     */
    virtual CARAPI PrepareStatementEx(
        /** [in] **/String sql, 
     ...
     *             if a problem occurs accessing the database.
     */
    virtual CARAPI PrepareStatementEx2(
        /** [in] **/String sql, 
     ...
     *             if a problem occurs accessing the database.
     */
    virtual CARAPI PrepareStatementEx3(
        /** [in] **/String sql, 
        /** [in] **/Int32 resultSetType,
        /** [in] **/Int32 resultSetConcurrency,
        /** [out] **/IPreparedStatement** stat)=0;
     ...
     *             if a problem occurs accessing the database.
     */
    virtual CARAPI PrepareStatementEx4(
        /** [in] **/String sql, 
        /** [in] **/Int32 resultSetType,
        /** [in] **/Int32 resultSetConcurrency, 
        /** [in] **/Int32 resultSetHoldability,
     ...
     *             if a problem occurs accessing the database.
     */
    virtual CARAPI PrepareStatementEc5(
        /** [in] **/String sql, 
     ...
     */
//    virtual CARAPI  void SetTypeMap(Map<String, Class<?>> map)=0;
     ...
     * the property.
     */
    virtual CARAPI SetClientInfoEx2(
        /** [in] **/String name,
        /** [out] **/String* str)=0;
