                        ...
                        RBTreeNodeBase*& rightmost)
{
    ...
    if (y != z) {          // relink y in place of z.  y is z's successor
        ...
        y->mParent = z->mParent;
        Elastos::Swap(y->mColor, z->mColor);
        y = z;
...
template <class T, class Alloc>
struct RBTreeBase : public RBTreeAllocBase<T, Alloc,
                               AllocTraits<T, Alloc>::S_instanceless>
{
...
public:
    ...
    {
        Elastos::Swap(mHeader, t.mHeader);
        Elastos::Swap(mNodeCount, t.mNodeCount);
        Elastos::Swap(mKeyCompare, t.mKeyCompare);
    }
