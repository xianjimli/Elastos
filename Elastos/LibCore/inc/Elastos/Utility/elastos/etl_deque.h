...
*/
template <class Tp, class Alloc>
class DequeBase : public DequeAllocBase<Tp, Alloc,
        AllocTraits<Tp, Alloc>::S_instanceless>
{
public:
...
public:                         // Constructor, destructor.
    ...
    void Swap(Deque& x)
    {
        Elastos::Swap(mStart, x.mStart);
        Elastos::Swap(mFinish, x.mFinish);
        Elastos::Swap(mMap, x.mMap);
        Elastos::Swap(mMapSize, x.mMapSize);
    }
