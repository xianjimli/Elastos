...
public:
    ...
    */
    ...
    CARAPI_(void) SetLength(Int32 length);
    /*!
    ...
    */
    ...
    CARAPI_(Int32) GetChar(UInt32 index) const;
    // CARAPI_(Int32) GetCharByOffset(UInt32 offset, UInt32 *nextOffset = NULL) const;

    CARAPI_(void) Insert(Int32 index, const String& str);
    CARAPI_(void) Insert(Int32 index, const char* str);

    CARAPI_(void) SetChar(Int32 index, Char32 ch);
    CARAPI_(void) DeleteChar(Int32 index);
...
private:
    ...
    */
    CARAPI_(void) Init(const char* s, Int32 step);
    /*!
