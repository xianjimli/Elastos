...
#endif
                i64v = *(Int32*)pSrcElemPtr;
                pSrcElemPtr += 4;
                i64v = (i64v < 32) | *(Int32*)pSrcElemPtr;
...
ECode CCallbackParcel::WriteArrayOf(
    /* [in] */ Handle32 pArray)
{
    Int32 size = sizeof(CarQuintet) + ((CarQuintet*)pArray)->m_size;
