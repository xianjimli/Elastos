...
CAR_INLINE _ELASTOS Boolean IsEqualEMuid(_ELASTOS REMuid r1, _ELASTOS REMuid r2)
{
...
CAR_INLINE _ELASTOS Boolean operator ==(_ELASTOS REMuid rguid1, _ELASTOS REMuid rguid2)
{
    return IsEqualEMuid(rguid1, rguid2);
}

CAR_INLINE _ELASTOS Boolean operator ==(_ELASTOS REMuid rguid, _ELASTOS RClassID rclsid)
{
    return IsEqualEMuid(rguid, rclsid.clsid);
}

CAR_INLINE _ELASTOS Boolean operator ==(_ELASTOS RClassID rclsid, _ELASTOS REMuid rguid)
{
    return IsEqualEMuid(rguid, rclsid.clsid);
}
...
CAR_INLINE _ELASTOS Boolean IsEqualUunm(const char *pUunm1, const char *pUunm2)
{
    return !_Impl_Strcmp(pUunm1, pUunm2);
}

CAR_INLINE _ELASTOS Boolean IsEqualClassId(_ELASTOS RClassID r1, _ELASTOS RClassID r2)
{
    return IsEqualEMuid(r1.clsid, r2.clsid) && IsEqualUunm(r1.pUunm, r2.pUunm);
}

CAR_INLINE _ELASTOS Boolean operator ==(_ELASTOS RClassID r1, _ELASTOS RClassID r2)
{
